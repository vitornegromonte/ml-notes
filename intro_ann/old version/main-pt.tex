...
Em sua essência, um perceptron é um mecanismo de decisão binário. Ele recebe um conjunto de valores reais, pondera sobre sua "importância"\footnote[2]{} e faz uma escolha baseada em um limiar de decisão. Imagine o perceptron como um pequeno porteiro: ele avalia as evidências (entradas), aplica seus próprios vieses e preferências (pesos) e entrega um veredito — ou 1 (“sim”) ou 0 (“não”)\footnote[3]{Original, o valores eram 1 e -1, para "sim" e "não". Decidi por deixar na interpretação mais comum de 0 e 1.}


\subsubsection{Fundamentação matemática de Perceptrons}
...
\subsubsection{Interpretação Geométrica do Perceptron}
...
\subsubsection{Regra de Treinamento do Perceptron}
